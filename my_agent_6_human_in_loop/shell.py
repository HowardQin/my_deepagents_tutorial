...
class ShellMiddleware(AgentMiddleware[AgentState, Any]):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            workspace_root: Working directory and virtual root for shell commands.
        ...
        description = (
            f"Execute a shell command directly on the host."
            f"{workspace_root} is the root directory in the context."
            f"It means any absolute path in the context should be prefixed with {workspace_root} before execution." 
            f"For example, 'mkdir /abc' should be 'mkdir {workspace_root}/abc/' and then execute." 
            f"Each command runs in a fresh shell. {workspace_root} is default current directory."
